...
export class TestGenerics_Inner2_DeepNest_DeepNestInterface$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestGenerics.Inner2.DeepNest.DeepNestInterface",
            methodName: "call"
        }
    ];
...
export class TestGenerics_Interface$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestGenerics.Interface",
            methodName: "call"
        }
    ];
...
export class TestImplicitMethodParams$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestImplicitMethodParams",
            methodName: "call"
        }
    ];
...
export class TestImplicitMethodParamsInGeneric$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestImplicitMethodParamsInGeneric",
            methodName: "call"
        }
    ];
...
export class TestInterface$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestInterface",
            methodName: "foo"
        },
        {
...
export class TestExtends$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestExtends",
            methodName: "qux"
        },
        {
...
export class TestPipeline_TestPointers$Params extends __S {
    ...
    adoptList(value: capnp.Orphan<capnp.List<TestInterface>>): void { __S.adopt(value, __S.getPointer(2, this)); }
    disownList(): capnp.Orphan<capnp.List<TestInterface>> { return __S.disown(this.getList()); }
    getList(): capnp.List<TestInterface> { return __S.getList(2, capnp.InterfaceList, this); }
    hasList(): boolean { return !__S.isNull(__S.getPointer(2, this)); }
    initList(length: number): capnp.List<TestInterface> { return __S.initList(2, capnp.InterfaceList, length, this); }
    setList(value: capnp.List<TestInterface>): void { __S.copyFrom(value, __S.getPointer(2, this)); }
...
export class TestPipeline$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestPipeline",
            methodName: "getCap"
        },
        {
...
export class TestCallOrder$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestCallOrder",
...
export class TestTailCallee$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestTailCallee",
            methodName: "foo"
        }
    ];
...
export class TestTailCaller$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestTailCaller",
            methodName: "foo"
        }
    ];
...
export class TestMoreStuff$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestMoreStuff",
            methodName: "callFoo"
        },
        {
...
export class TestMembrane_Thing$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestMembrane.Thing",
...
export class TestMembrane$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestMembrane",
...
export class TestContainMembrane extends __S {
    ...
    initList(length: number): capnp.List<TestMembrane_Thing> { return __S.initList(1, capnp.InterfaceList, length, this); }
    setList(value: capnp.List<TestMembrane_Thing>): void { __S.copyFrom(value, __S.getPointer(1, this)); }
...
export class TestKeywordMethods$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestKeywordMethods",
            methodName: "delete"
        },
        {
...
export class TestAuthenticatedBootstrap$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestAuthenticatedBootstrap",
...
export class TestNameAnnotationInterface$Client {
    ...
    static readonly methods: [
    ...
    ] = [
        {
            ...
            methodId: 0,
            interfaceName: "packages/capnp-ts/test/integration/test.capnp:TestNameAnnotationInterface",
