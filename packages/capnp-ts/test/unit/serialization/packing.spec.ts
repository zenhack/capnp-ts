...
type Word64 = [byte, byte, byte, byte, byte, byte, byte, byte];
const TAG_DATA = [
  {
    tag: 0b00000000,
    weight: 0,
    word: [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00] as Word64,
  },
  {
    tag: 0b00110001,
    weight: 3,
    word: [0x09, 0x00, 0x00, 0x00, 0x04, 0x01, 0x00, 0x00] as Word64,
  },
  {
    tag: 0b00000001,
    weight: 1,
    word: [0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00] as Word64,
  },
  {
    tag: 0b11111111,
    weight: 8,
    word: [0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff] as Word64,
  },
  {
    tag: 0b10000000,
    weight: 1,
    word: [0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff] as Word64,
  },
  {
    tag: 0b11111111,
    weight: 8,
    word: [0x0a, 0x15, 0x01, 0xac, 0x6d, 0x9f, 0x03, 0xf2] as Word64,
  },
  {
    tag: 0b00111111,
    weight: 6,
    word: [0x41, 0x53, 0x53, 0x48, 0x41, 0x54, 0x00, 0x00] as Word64,
  },
];
